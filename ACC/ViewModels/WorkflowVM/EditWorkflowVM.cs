...
{
    public class EditWorkflowVM
    {

        public int proId { get; set; }
        public int? Id { get; set; }
        [Required(ErrorMessage = "Name is required")]
        [Remote(action: "IsNameAvailable", controller: "Workflow", AdditionalFields = "Id,proId", ErrorMessage = "Name already exists for this project")]
